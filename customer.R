...
train=read.csv("project3.csv")
str(train) #DATATYPES OF  TRAIN DATA
...
#We have a unbalanced data,where 90% of the data is the data of number of customers those will not make a transaction
...
test_df=read.csv('project test.csv')
head(test_df)
...
# therefore,we can conclude that the model is not performing well on imbalanced data.
